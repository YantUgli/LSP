...
@section('content_header')<h1 class="m-0 text-dark">Edit Pelanggan</h1>
@stop
@section('content')
...
@error('alamat') is-invalid @enderror" id="alamat" placeholder="Alamat" name="alamat" value="{{$pelanggan->alamat ?? old('alamat')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control 
@error('no_hp') is-invalid @enderror" id="no_hp" placeholder="Masukan Nomor" name="no_hp" value="{{$pelanggan->no_hp ?? old('no_hp')}}">
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('storage/' . $pelanggan->foto) }}" class="img-thumbnail d-block  border-0" name="tampil" width="15%" id="tampil">
                        <input type="file" class="form-control 
@error('foto') is-invalid @enderror" id="foto" placeholder="Masukan foto Anda" name="foto" value="{{$pelanggan->foto ?? old('foto')}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="hidden" name="id_user" id="id_user" value="{{$pelanggan->user->id ?? old('id_user')}}">
                            <input type="text" class="form-control 
@error('email') is-invalid @enderror" placeholder="Temukan id user" id="email" name="email" value="{{$pelanggan->user->email?? old('email')}}"
