...
@section('content_header')<h1 class="m-0 text-dark">Tambah Berita</h1>
@stop
@section('content')
...
@error('tgl_post') is-invalid @enderror" id="tgl_post" placeholder="Masukan Isi Post" name="tgl_post"
                            value="{{old('tgl_post')}}">
...
@error('kategori_berita') is-invalid @enderror" placeholder="Temukan id user" id="kategori_berita" name="kategori_berita"
                                value="{{old('kategori_berita')}}" aria-label="user" aria-describedby="cari" readonly>
