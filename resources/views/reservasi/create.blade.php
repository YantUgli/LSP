...
@error('nama_lengkap') is-invalid @enderror" placeholder="Temukan id Pelanggan" id="nama_lengkap" name="nama_lengkap" value="{{old('nama_lengkap')}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('nama_paket')  is-invalid  @enderror" placeholder="Data Daftar Wisata" id="nama_paket" name="nama_paket" value="{{old('nama_paket')}}" aria-label="nama_paket" aria-describedby="cari" readonly>
                            <button class="btn  btn-warning" type="button" data-bs-toggle="modal" id="cari" data-bs-target="#staticBackdrop1"></i> Cari Data Daftar Paket</button>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="tgl_reservasi_wisata">tanggal Reservasi</label>
                        <input type="datetime-local" class="form-control 
@error('tgl_reservasi_wisata') is-invalid @enderror" id="tgl_reservasi_wisata" placeholder="Tanggal Reservasi" name="tgl_reservasi_wisata" value="{{old('tgl_reservasi_wisata')}}">
                        @error('tgl_reservasi_wisata') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="harga">Harga</label>
                        <input type="number" class="form-control 
@error('harga') is-invalid @enderror" id="harga" readonly onkeyup="hitung()" placeholder="Harga" name="harga" value="{{old('harga')}}">
                        @error('harga') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="jumlah_peserta">Jumlah Peserta</label>
                        <input type="number" class="form-control 
@error('jumlah_peserta') is-invalid @enderror" id="jumlah_peserta"  onkeyup="hitung()" placeholder="Jumlah Peserta" name="jumlah_peserta" value="{{old('jumlah_peserta')}}">
                        @error('jumlah_peserta') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="diskon">Diskon %</label>
                        <input type="decimal" class="form-control 
@error('diskon') is-invalid @enderror" id="diskon" onkeyup="hitung()" placeholder="Diskon" name="diskon" value="{{old('diskon')}}" readonly>
...
@error('file_bukti_tf') is-invalid @enderror" id="file_bukti_tf" placeholder="Masukan Bukti Transfer Anda" name="file_bukti_tf" value="{{old('file_bukti_tf')}}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('status_reservasi_wisata') isinvalid @enderror" id="exampleInputlevel" name="status_reservasi_wisata">
                            ...
                            <option value="bayar" @if(old('status_reservasi_wisata')=='bayar' )selected @endif>Bayar</option>
                                    ...
                                    <table class="table table-hover table-bordered tablestripped" id="example2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$p->alamat}}</td>
                                                <td>
                                                    <button type="button" class="btn  btn-primary btn-xs" onclick="pilih('{{$p->id}}',  '{{$p->nama_lengkap}}', '{{$p->no_hp}}', '{{$p->alamat}}')" data-bs-dismiss="modal">
                                                        Pilih
                                                    </button>
                                                </td>
                                            </tr>
    ...
    btn-xs" onclick="pilih1('{{$dp->id}}',  '{{$dp->nama_paket}}',  '{{$dp->harga_per_pack}}',  '{{$dp->diskon}}')" data-bs-dismiss="modal">
                                                        Pilih
                                                    </button>
                                                </td>
                                            </tr>
