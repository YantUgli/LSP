...
@section('content_header')<h1 class="m-0 text-dark">Tambah Obyek Wisata</h1>
@stop
@section('content')
...
@error('deskripsi_wisata') is-invalid @enderror" id="deskripsi_wisata" placeholder="Tulis Deskripsi Wisata"
                            name="deskripsi_wisata" value="{{old('deskripsi_wisata')}}">
...
@error('kategori_wisata') is-invalid @enderror" placeholder="Temukan id Kategori" id="kategori_wisata"
                                name="kategori_wisata" value="{{old('kategori_wisata')}}" aria-label="user"
